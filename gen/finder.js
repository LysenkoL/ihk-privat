...
window.GENFINDER = (function () {
  ...
  function werkzeuge() {
    const W = [
      ...
      ["Themen-Radar", "Was kommt am 30.09.? Prognose je Thema + dein Stand", "radar",
        () => window.GENRADAR && window.GENRADAR.oeffnen(), "radar prognose themen wahrscheinlich häufigkeit statistik analyse vorhersage priorität"],
      ["Prognose-Prüfung 1", "Kosten & Strom · IPv4/IPv6 · Sicherheit & Backup · Algorithmus & ER", "radar",
        () => window.GENAZUBI && window.GENAZUBI.oeffnen("azprog1"), "prognose prüfung simulation 90 minuten mix ihk azubi"],
      ["Prognose-Prüfung 2", "Nutzwertanalyse & Leasing · WLAN · Signatur & VPN · Netzplan, OOP & KI", "radar",
        () => window.GENAZUBI && window.GENAZUBI.oeffnen("azprog2"), "prognose prüfung simulation 90 minuten mix ihk azubi"],
      ["Prognose-Prüfung 3", "Rechnung & Lizenzen · PoE & Ergonomie · Speicher & Übertragung · Programmierung", "radar",
        () => window.GENAZUBI && window.GENAZUBI.oeffnen("azprog3"), "prognose prüfung simulation 90 minuten mix ihk azubi"],
      ["Kurzfragen schreiben", "6 Fragen · Antworten in ganzen Sätzen", "satz",
        () => window.GENSATZ && window.GENSATZ.starten(null, { modus: "schreiben", anzahl: 6 }), "kurzfragen satzbau formulieren erläutern begründen"],
      ["Kurzfragen: welche Antwort gibt volle Punkte?", "10 Fragen antippen statt tippen", "satz",
        () => window.GENSATZ && window.GENSATZ.starten(null, { modus: "auswahl", anzahl: 10 }), "kurzfragen auswählen volle punkte quiz"],
      ["Kurzfragen aufdecken", "15 Fragen · Musterantwort zeigen, selbst einschätzen", "satz",
        () => window.GENSATZ && window.GENSATZ.starten(null, { modus: "aufdecken", anzahl: 15 }), "kurzfragen aufdecken schnell karteikarten"],
