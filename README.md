...
Из 279 заданий 17 (76 баллов) помечены как **вне действующего каталога** —
...
* **Офлайн PWA:** оболочка, генераторы и уже загруженные материалы кэшируются
  Service Worker v27; изображения целого экзамена надо заранее загрузить
...
* **Офлайн PWA:** интерфейс и уже открытые темы кэшируются Service Worker v27;
